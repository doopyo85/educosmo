...
if (typeof BoardNotification === 'undefined') {
    ...
    // 전역 등록
    window.BoardNotification = BoardNotification;
}

// 알림 시스템 인스턴스 생성 및 전역 등록
if (!window.boardNotification) {
    window.boardNotification = new window.BoardNotification();
}